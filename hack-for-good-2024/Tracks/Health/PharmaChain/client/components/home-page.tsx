      ...
      <main className="flex-grow">
        <section className="relative h-screen flex items-center justify-center">
          <Image
            ...
            src="https://r10.ieee.org/bombay-cs/wp-content/uploads/sites/99/supply-chain-network-applications-multi-party-networks-5.jpg"
            // src="https://pharma-trends.com/wp-content/uploads/2020/11/blog_20201123_2.jpg"
            alt="Pharmaceutical supply chain"
            layout="fill"
            objectFit="cover"
            className="absolute inset-0 bg-gradient-to-b from-black/70 via-gray-900/80 to-gray-800/90"
          />
          ...
          <div className="relative z-10 text-center text-white">
            <h2 className="text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600 drop-shadow-xl ">
              Pharmaceutical Supply Chain with Blockchain
            </h2>
            <p className="text-2xl mb-8 max-w-3xl mx-auto text-gray-200 bg-opacity-70 bg-gray-900 p-6 rounded-lg shadow-lg">
              Revolutionizing pharmaceutical logistics through secure, transparent, and efficient blockchain solutions
            </p>
            <button className="bg-cyan-500 hover:bg-cyan-600 text-white text-lg px-8 py-3 rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105">
              View Project
            </button>
          </div>
...
function FeatureCard({ icon, title, description }) {
  return (
    <Card className="bg-slate-700 border-slate-600">
      <CardHeader className="text-center flex-row pb-2">
        {icon}
        <CardTitle className="text-cyan-400  pt-2 pl-2">{title}</CardTitle>
      </CardHeader>
      <CardContent>
